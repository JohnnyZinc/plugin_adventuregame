        ...
        if clist[0] == f"{trigger_prefix}停止冒险":
            ...
            if sessionid not in self.games or clist[0] == f"{trigger_prefix}开始冒险":
                if len(clist) > 1:
                    ...
                    story = "当你醒来时，发现自己身处一个古老的城堡内。你站在一个石头铺成的走廊中央，两边是黑暗的门廊。远处传来微弱的声音，仿佛有隐约的低语。地板下是一个石质的螺旋楼梯，通向未知的楼上。你的周围没有其他人，只有寂静和古老的氛围。在这神秘的城堡中，你能做的事情有很多。请告诉我你想要做什么，或者询问我关于周围环境的更多信息。"
